...
const TaskTableRow = ({
  ...
  return (
    <tr>
      ...
      <td className="table__cell">{task.name}</td>
      <td className="table__cell table__cell_wide">{task.description}</td>
      <td className="table__cell table__cell_centered">{task.category}</td>
      <td className="table__cell table__cell_centered table__cell_wide">
        {task.date}
      </td>
      <td className="table__cell table__cell_centered">{task.time}</td>
      <td className="table__cell table__cell_centered">{task.priority}</td>
      <td className="table__cell table__cell_centered">{task.fulfillment}%</td>
      <td className="table__cell table__cell_action">
